...
plt.rcParams['mathtext.fontset'] = 'stix'  # ← add this
...
plt.plot(k_list,down_list,marker='o',markersize=3.0,color='#4F7942')
...
# plt.ylabel(r"$x_U,~x_{Dn},~x_D,C_T$",fontsize=30)
plt.tight_layout()
plt.savefig('Degree_vs_UDDf.png')
plt.show()