...
# Parameters
num_agents = 1100 # Number of agents
max_games = (num_agents-1)*550
...
#==================================================================
@njit
def new_generation(kappa, ownimage, payoff, imagescore_others, mutation_rate):
    N = len(kappa)
    ...
    for i in range(N):
        ...
        if np.random.random() > mutation_rate:
            ...
            new_kappa[i] = np.random.randint(0, 3) #with mutation rate kappa can take any of the three 0,1,2
...
for gen in tqdm(range(num_generations), desc="Simulating"):
    ...
    new_generation(kappa, ownimage, payoff,imagescore_others,mutation_rate)
