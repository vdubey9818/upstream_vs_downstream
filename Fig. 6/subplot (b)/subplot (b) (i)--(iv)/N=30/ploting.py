...
data = np.loadtxt("k_vs_frequencies_N=30.txt")
...
plt.grid()
plt.title('Strategy frequency vs Degree N=30 (average over 12 realizations)')
plt.savefig('new_born_updateN=30network.png')
plt.show()