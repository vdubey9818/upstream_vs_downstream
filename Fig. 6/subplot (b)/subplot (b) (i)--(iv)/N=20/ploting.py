...
data = np.loadtxt("k_vs_frequencies_N=20.txt")
...
plt.grid()
plt.title('Strategy frequency vs Degree N=20 (average over 15 realizations)')
plt.savefig('new_born_updateN=20network.png')
plt.show()